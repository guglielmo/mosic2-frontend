...
@Component({
    selector: 'delibere-upload',
    templateUrl: './delibere-upload.component.html'
})

export class DelibereUploadComponent implements OnInit {
    @Input() type: string;
    ...
    constructor(
        ...
        this.baseAPIURL =  this.config.baseAPIURL + '/api/delibere/';
    }
