...
var $buo = function (op, test) {
    ...
    if (this.op.apiver < 4)
        var vsmin = {i: 9, f: 10, o: 20, s: 7, n: 12}; else
    ...
    if (op.l)
        this.op.url = op.url || "/assets/" + ll + "/update-browser.html#" + jsv + ":" + pageurl; else
        this.op.url = op.url || "/assets/update-browser.html#" + jsv + ":" + pageurl;
    ...
    e.src = op.jsshowurl || (/file:/.test(location.href) && "assets/update.show.min.js") || "/assets/update.show.min.js";
